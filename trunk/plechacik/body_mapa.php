...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		<td width="89" height="30" background="./imgs/main_lista_left.gif" align="center" valign="middle"><img src="./imgs/icon_mapa.gif"></td>
		<td width="*" height="30" background="./imgs/main_lista_middle.gif" class="oznamNazov">Mapka umiestnenia obce</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		...
		<td width="*" bgcolor="#ffffff" align="center"><img src="./imgs/mapa.jpg" border="0"></td></td>
