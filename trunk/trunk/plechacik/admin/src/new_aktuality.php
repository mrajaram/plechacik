...
<br>
<div align="center" class="cisla">VLOŽ NOVÚ AKTUALITU</div>
<br>
<br>
...
$pridany = date("Y-n-j");
  ...
  if(!@mysql_select_db($db_name,$link)){
    echo "Server problems, try to log in later."; exit;
  	...
  	$text = stripslashes($_POST["aktualityText"]);
//  	echo $text; 
	$stmt = "insert into aktuality SET nazov='$nazov', text='$text', pridany='$pridany'";
...
?>
<form action="?action=9" method="post" name="formoznam" onsubmit="return checkOznam();">
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		<td class="textmain"><b>Názov aktuality:&nbsp;&nbsp;</b><input type="Text" name="nazov" style="width:170px" onFocus="this.style.background='#FFFFFF'; this.style.color='#000000'" onBlur="this.style.background='#FcFcFc'; this.style.color='#000000'"></td>
	</tr>
	<tr>
		<td class="textmain">
			<?php
