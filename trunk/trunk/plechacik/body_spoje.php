...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		<td width="89" height="30" background="./imgs/main_lista_left.gif" align="center" valign="top"><img src="./imgs/icon_spoje.gif"></td>
		<td width="*" height="30" background="./imgs/main_lista_middle.gif" class="oznamNazov">Spoje</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		...
		<td width="*" bgcolor="#fcfcfc"><?require_once("./src/spoje.php")?></td>
