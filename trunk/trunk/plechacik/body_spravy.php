...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		<td width="89" height="30" background="./imgs/main_lista_left.gif" align="center" valign="middle"><img src="./imgs/icon_spravy.gif"></td>
		<td width="*" height="30" background="./imgs/main_lista_middle.gif" class="oznamNazov">Spravodajstvo</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		...
		<td width="*" bgcolor="#ffffff" align="center"><? require_once("./src/spravy.php"); ?></td></td>
