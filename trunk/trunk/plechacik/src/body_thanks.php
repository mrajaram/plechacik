...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		...
		<td width="89" height="30" background="./imgs/main_lista_left.gif" align="center" valign="middle"><img src="./imgs/icon_thanks.gif"></td>
		<td width="*" height="30" background="./imgs/main_lista_middle.gif" class="oznamNazov">Naše poïakovanie patrí ...</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="95%" align="center">
	<tr>
		...
		<td width="*" bgcolor="#ffffff" align="center">&nbsp;&nbsp;</td></td>
		<td width="7" background="./imgs/main_body_right.gif"><img 
src="./imgs/blank.gif"></td>
	</tr>
</table>
<!-- koniec pre body -->
