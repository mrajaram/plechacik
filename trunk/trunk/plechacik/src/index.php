...
<!-- 									<span class="small"><br></span>&nbsp;&nbsp;<? echo colorArrow(8); ?>&nbsp;<a href="?menu=8" class="menu">Štatistické údaje</a> -->
									...
									<span class="small"><br></span>&nbsp;&nbsp;<? echo colorArrow(9); ?>&nbsp;<a href="http://www.plechotice.sk/chat/" class="menu" target="_blank">Chat</a>
...
echo "<td width=\"*\" valign=\"top\">";
	switch ($menu){
		...
		case 6: $fn = "body_sport.php"; break;
